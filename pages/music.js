...
const Music = (props) => {
	...
	let [isOver, useIsOver] = useState(false);
										...
										{props.spotify_data.tracks.items.map((i, t) => {
											return (
												<li className={list_styles.list_element}>
													<div
														// onMouseOver={()=>useIsOver(!isOver)}
														// onMouseOut={()=>useIsOver(!isOver)}
													>
														{
															// (isOver) ?
															// 	<>
															...
															// 						}}
															// 					>
															// 						{/* make into play button svg */}
															// 					preview
															// 				</button>
															// 				</div> :
															// 				<div className={list_styles.preview_button}></div>
															// 		}
															// 	</> :
