...
const Nav = (props) => {
	let [toggle, toggleUseState] = useState(false);
			...
			<ul className={nav_styles.navbar_nav}>
				<li className={nav_styles.logo}>
					...
					*/}
					...
					{/* <Link href="/" className={nav_styles.nav_link} /> */}
					<a href="/" className={nav_styles.nav_link}>
				...
				<li className={nav_styles.nav_item}>
					<a href="/hello" className={nav_styles.nav_link}>
						<svg aria-hidden="true" focusable="false" data-prefix="fas"
							data-icon="headphones-alt" class="svg-inline--fa fa-headphones-alt fa-w-16" role="img"
				...
				<li className={nav_styles.nav_item} id="themeButton">
					<a href="#" className={nav_styles.nav_link}>
