...
const LightIcon = () => {
	return (
		<svg className={nav_styles.theme_icon} id="lightIcon" aria-hidden="true" focusable="false" data-prefix="fad"
...
const SolarIcon = () => {
	return (
		<svg className={nav_styles.theme_icon} id="solarIcon" aria-hidden="true" focusable="false" data-prefix="fad"
